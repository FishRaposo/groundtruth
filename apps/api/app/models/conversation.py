...
class Message(Base):
    ...
    retrieved_chunks: Mapped[list[str]] = mapped_column(
        JSON, default=list
...
class ConversationContext(Base):
    ...
    added_reason: Mapped[str] = mapped_column(
        String(50), default="retrieval"
    )  # retrieval, user_add, auto_expand
