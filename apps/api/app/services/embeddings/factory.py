...
def get_embedding_provider(
    ...
    **kwargs: Any,
    ...
    Args:
        provider_name: Provider identifier (openai, cohere, ollama,
    ...
    dimensions = kwargs.pop("dimensions", None) or getattr(
    ...
    if provider == "openai":
        ...
        base_url = kwargs.pop("base_url", None) or getattr(
        ...
        device = kwargs.pop("device", None) or getattr(
