...
from app.services.query.expansion import HyDENetwork, QueryExpander
...
class EnhancedRetrievalService:
    ...
    async def retrieve(  # noqa: C901
        ...
        for q in queries:
            results = await self._retrieve_with_strategy(
                q, strategy, top_k or strategy.top_k
            )
        ...
        if strategy.use_reranker:
            ...
            docs_for_rerank = [(chunk.content, chunk) for chunk, _ in fused]
